...
//  GHFollowers
//
//  Created by Kirill Gusev on 16.03.2024.
//
...
class GFUserInfoHeaderVC: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.accessibilityIdentifier = "GF_USER_INFO_VIEW"
        addSubviews()
        setupConstraints()
        configureUI()
    }
    ...
    func configureUI() {
        ...
        locationImageView.image = UIImage(systemName: SFSymbols.locationImageName)
